// React Bits <ScrollReveal /> (gsap ScrollTrigger) — patched: scoped cleanup
// via gsap.context (the original killed every ScrollTrigger on the page).
...
const ScrollReveal = ({
  ...
  useEffect(() => {
    ...
    return () => ctx.revert()
  }, [scrollContainerRef, enableBlur, baseRotation, baseOpacity, rotationEnd,
      wordAnimationEnd, blurStrength])
