// React Bits <Particles /> (ogl) — patched: pointer parallax listens on
// window so content layered above the canvas doesn't block it.
...
const Particles = ({
  ...
  useEffect(() => {
    ...
    // Degrade gracefully on devices without WebGL — the page must never
    // crash over a decorative background.
    let renderer
    let gl
    try {
    ...
    let camera, geometry, program, particles
