// React Bits <MagicBento /> (gsap) — patched: cards passed as a prop,
// indigo glow, shadow-free, custom node content per card.
...
const MagicBento = ({
  ...
  return (
    <>
      {enableSpotlight && (
        <GlobalSpotlight gridRef={gridRef} disableAnimations={shouldDisableAnimations}
                         enabled={enableSpotlight} spotlightRadius={spotlightRadius}
                         glowColor={glowColor} />
      )}
      <div className="card-grid bento-section" ref={gridRef}>
        {cards.map((card, index) => {
          ...
          if (enableStars) {
            return (
              <ParticleCard key={index} className={baseClassName}
                            style={{ '--glow-color': glowColor }}
                            disableAnimations={shouldDisableAnimations}
                            particleCount={particleCount} glowColor={glowColor}
                            enableTilt={enableTilt} clickEffect={clickEffect}
          ...
          return (
            <div key={index} className={baseClassName} style={{ '--glow-color': glowColor }}>
              {inner}
            </div>
          )
        })}
