// React Bits <VariableProximity /> (motion) — patched: uses our self-hosted
// Inter variable font (wght axis) instead of a Google Fonts import (CSP).
...
const VariableProximity = forwardRef((props, ref) => {
  ...
  const parsedSettings = useMemo(() => {
    const parseSettings = settingsStr =>
      new Map(settingsStr.split(',').map(s => s.trim()).map(s => {
  ...
  return (
    <span ref={ref} className={`${className} variable-proximity`} onClick={onClick}
          style={{ display: 'inline', ...style }} {...restProps}>
